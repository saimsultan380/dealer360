...
const navigation: NavItem[] = [
    ...
    { name: 'Exchange Deals', href: '/dashboard/exchange-deals', icon: Repeat2, moduleKey: 'exchange_deals' },
    ...
    { name: 'Pending Deals', href: '/dashboard/deals/pending', icon: HandshakeIcon, moduleKey: 'deals' },
...
export function Sidebar() {
    ...
    const staffFiltered =
        Array.isArray(staffOverride) && staffOverride.length
            ...
            : moduleFiltered;
    const navItems: NavItem[] = role ? filterNavByRole({ role, items: staffFiltered }) : staffFiltered;
            ...
            <div className="flex h-full flex-col">
                ...
                <div className="border-t px-3 py-4">
                    ...
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align={isCollapsed ? 'start' : 'end'} side={isCollapsed ? 'right' : 'top'}>
