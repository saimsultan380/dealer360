                    ...
                    <div className="grid gap-2 sm:gap-3 grid-cols-3">
                        ...
                        >
                            ...
                            <div className="text-center min-h-8">
                                <Label className="font-semibold text-xs sm:text-sm block">Light</Label>
                        ...
                        >
                            ...
                            <div className="text-center min-h-8">
                                <Label className="font-semibold text-xs sm:text-sm block">Dark</Label>
                                <p className="text-xs text-muted-foreground">
                                    Dark mode
                                </p>
                            </div>
                        ...
                        >
                            ...
                            <div className="text-center min-h-8">
                                <Label className="font-semibold text-xs sm:text-sm block">System</Label>
                                <p className="text-xs text-muted-foreground">
                                    Follow system
                                </p>
                            </div>
