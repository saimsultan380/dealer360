...
import { getInvestors, InvestorWithBalance, deleteInvestor } from '@/lib/actions/investors';
...
export default function InvestorsPage() {
    ...
    const totalWithdrawn = investors.reduce((sum, inv) => sum + inv.total_withdrawn, 0);
                    ...
                    {error ? (
                        ...
                        <div className="p-12 text-center">
                            ...
                            <p className="text-xs text-muted-foreground mb-4">
                                {searchQuery ? 'Try adjusting your search' : 'Get started by adding your first investor'}
                            </p>
                            {!searchQuery && (
                                <Button onClick={() => router.push('/dashboard/investors/new')}>
                                    <Plus className="mr-2 h-4 w-4" />
