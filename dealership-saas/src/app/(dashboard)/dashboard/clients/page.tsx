...
import { getClients, ClientWithStats, deleteClient } from '@/lib/actions/clients';
...
function CircularProgress({ percentage, size = 80, strokeWidth = 8, color = '#f59e0b' }: {
    percentage: number;
    size?: number;
    strokeWidth?: number;
    color?: string;
...
// Sparkline Component
function Sparkline({ data, color = '#10b981' }: { data: { month: string; value: number }[]; color?: string }) {
    return (
...
export default function ClientsPage() {
    ...
    let filteredClients = clients.filter((client) => {
        ...
        if (activeFilters.includes('has_dues') && client.total_dues === 0) return false;
        if (activeFilters.includes('high_spender') && client.total_spent < 1000000) return false;
        ...
        <div className="space-y-8 pb-8">
            ...
            <div className="grid gap-4 md:grid-cols-3">
                ...
                <Card className="relative overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground mb-3">All-time purchases</p>
            ...
            {showCharts && (
                <div className="grid gap-4 md:grid-cols-2 animate-in fade-in slide-in-from-top-2 duration-300">
                    ...
                    <Card className="relative overflow-hidden transition-all duration-300 border-border/50">
                        <CardHeader>
                            <div className="flex items-center justify-between">
                                <div>
                                    <CardTitle className="text-lg font-bold">Client Distribution</CardTitle>
                                    <CardDescription className="mt-1">By vehicle type preference</CardDescription>
                                </div>
                                <div className="h-10 w-10 rounded-lg bg-blue-500/10 flex items-center justify-center">
                        ...
                        <CardContent>
                            <div className="h-[240px]">
                                <ResponsiveContainer width="100%" height="100%">
                                    <BarChart data={clientDistribution} margin={{ top: 10, right: 10, left: 10, bottom: 5 }}>
                    ...
                    <Card className="relative overflow-hidden transition-all duration-300 border-border/50">
                        <CardHeader>
                            <div className="flex items-center justify-between">
                                <div>
                                    <CardTitle className="text-lg font-bold">Top 5 High-Value Clients</CardTitle>
                                    <CardDescription className="mt-1">Highest spending clients</CardDescription>
                                </div>
                                <div className="h-10 w-10 rounded-lg bg-emerald-500/10 flex items-center justify-center">
                            ...
                            <div className="h-[240px]">
                                <ResponsiveContainer width="100%" height="100%">
                                    ...
                                    >
                                        ...
                                        <Tooltip
                                            cursor={false}
                                            formatter={(value: number) => [`PKR ${value.toLocaleString()}`, 'Total Spent']}
                                            contentStyle={{
                                                backgroundColor: 'hsl(var(--popover))',
                                                border: '1px solid hsl(var(--border))',
                                                borderRadius: '8px',
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {[
                                ...
                                { id: 'new_this_month', label: 'New This Month', icon: TrendingUp },
                            ].map((filter) => {
