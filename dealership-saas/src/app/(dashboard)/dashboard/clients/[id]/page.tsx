            ...
            <div className="space-y-8">
                ...
                <Card>
                    <CardContent className="pt-6">
                        <p className="text-destructive">Error: {error || 'Client not found'}</p>
                    </CardContent>
                </Card>
            </div>
        );
    ...
    return (
        <div className="space-y-8">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">Client details and transaction history</p>
                        </div>
                    </div>
                </div>
            ...
            <div className="grid gap-4 md:grid-cols-3">
                ...
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-sm font-medium">Remaining Dues</CardTitle>
                        ...
                        {client.cnic ? (
                            <div className="flex items-start gap-3">
                                ...
                                <div className="min-w-0">
                                    ...
                                    <p className="text-sm text-muted-foreground break-words">{client.cnic}</p>
                                </div>
                            </div>
                        ) : (
                            <div></div>
                        ...
                        {client.notes && (
                            <div className="flex items-start gap-3 md:col-span-2">
                                <div className="min-w-0 flex-1">
                                    ...
                                    <p className="text-sm text-muted-foreground break-words whitespace-pre-wrap">{client.notes}</p>
                                </div>
                            </div>
                        )}
                    </div>
                            ...
                            <TableBody>
                                {transactions.map((transaction) => {
                                    ...
                                    <TableRow key={transaction.id}>
                                        ...
                                        <TableCell>
                                            {transaction.vehicle_make && transaction.vehicle_model ? (
                                                <div className="flex items-center gap-2">
                                        ...
                                        <TableCell className="text-right text-green-600">
                                            PKR {parseFloat((transaction.paid_amount || 0).toString()).toLocaleString()}
                                        </TableCell>
                                        <TableCell className="text-right">
                                            {transaction.remaining_due > 0 ? (
                                                <span className="font-semibold text-amber-600">
                                                    PKR {parseFloat(transaction.remaining_due.toString()).toLocaleString()}
                                                </span>
                                            ) : (
                                                <span className="text-muted-foreground">-</span>
                                            )}
