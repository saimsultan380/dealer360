...
import { Car, CheckCircle2, Clock3, DollarSign, Plus, Wrench } from 'lucide-react';
...
export default async function InventoryPage({
    ...
    const { data: vehicles, metadata, error } = await getVehicles({ query, status, page, limit });
    ...
    const inServiceCount = allVehicles.filter((v) => v.status === 'in_service').length;
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-sm font-medium">Reserved / In Service</CardTitle>
